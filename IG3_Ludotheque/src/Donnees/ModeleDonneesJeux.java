...
public class ModeleDonneesJeux extends AbstractTableModel{
	...
	private final String[] entetes = {"Id", "Titre", "Editeur", "Annee de parution", "Age recommandé", "Nombre de joueurs min", "Nombre de joueurs max", "Reference", "Exemplaires","Reserver / Emrpunter", "Editer", "Supprimer"};	//Titres des colonnes
