...
public class ModeleDonneesJeux extends AbstractTableModel{
	...
	private final String[] entetes = {"Id", "Titre", "Editeur", "Annee de parution", "Age recommand�", "Nombre de joueurs min", "Nombre de joueurs max", "Reference", "Statut", "Editer", "Supprimer"};	//Titres des colonnes
